...
try {
  ...
  await page.locator('.manual-sidebar a[href="#manual-13-keyboard-and-mouse-reference"]').click();
  await page.locator('.manual-sidebar a[href="#manual-131-current-keyboard-shortcuts"]').click();
