...
`spacemouse-addon.cpp` exposes cached camera state to the native 3Dconnexion Navigation Library. It never exposes object transformation setters. The Windows editor preload loads the addon; browser and Floating Preview sessions do not.
